...
if(isset($_GET['draw']))
{
    ...
    $query = "SELECT 
                    bills.merchant_id,
                    bills.description,
                    COALESCE(SUM(bills.amount),0) bills_total_amount,
                    COALESCE(SUM(bills.amount-bills.remaining_payment),0) bills_total_payment,
                    COALESCE(SUM(bills.remaining_payment),0) bills_total_remaining_payment,
